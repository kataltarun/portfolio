...
const Experience = () => {
  ...
  return (
    <section className="px-6 py-10" id= "experience" >
      <h2 className="text-4xl md:text-4xl font-medium tracking-tight mb-10"> Skills & Courses</h2>
        ...
        <div className="flex justify-center items-center">
            ...
            <div className="w-full backdrop-blur-3xl p-4 bg-stone-600/10 rounded-lg">
              ...
              <ul className=" flex justify-between  list-disc list-inside gap-16 flex-wrap">
                ...
                <li >MongoDB</li>
                <li >PostgreSQL</li>
                <li className="w-full"> 100XDEVS Cohort ~ Harkirat Singh</li>
                <li className="w-full">Fullstack Web Development bootcamp ~ Angela YU</li>
                <li>Sigma Web Development ~ CodeWithHarry</li>
